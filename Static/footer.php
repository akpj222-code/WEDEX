<footer class="bg-gray-900 text-gray-300 py-12">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 text-center md:text-left">
                <div>
                    <div class="flex items-center justify-center md:justify-start space-x-2 mb-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white">WEDEX</h3>
                            <p class="text-xs">Healthcare Services</p>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li>📞 +234 803 516 1651</li>
                        <li>✉️ wedexhealthcareservices@gmail.com</li>
                        <li>📍 21 Enerhen Road, Effurun, Delta State, Warri,Nigeria</li>
                    </ul>
            ...
            <div class="border-t border-gray-800 pt-8 text-center text-sm">
                <p>&copy; 2025 WEDEX Healthcare Services. All rights reserved.</p>
                <p class="mt-2 text-gray-400">
                   <p style="color: #475569; font-weight: 600;">ICARUSTUDIO</p>
                </p>
            </div>
        </div>
    </footer>
