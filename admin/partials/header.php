        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="orders" class="text-gray-600 hover:text-teal-600 font-medium">Orders</a>
            ...
            <div id="mobile-menu" class="hidden md:hidden pb-4">
                <nav class="flex flex-col space-y-4">
                    ...
                    <a href="orders" class="text-gray-600 hover:text-teal-600 font-medium">Orders</a>
                    <a href="../" target="_blank" class="text-gray-600 hover:text-teal-600 font-medium">View Site</a>
                    <span class="text-gray-700 border-t pt-4">Welcome, <?php echo htmlspecialchars($_SESSION['admin_username'] ?? 'Admin'); ?></span>
